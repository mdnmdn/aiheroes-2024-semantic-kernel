...
public class Sample15_SampleTextMemory
{
    ...
    [Experimental("SKEXP0001")]
    private static async Task RunWithStoreAsync(IMemoryStore store, CancellationToken cancellationToken)
    {
        ...
        var textMemory = new SemanticTextMemory(store, embeddings);
