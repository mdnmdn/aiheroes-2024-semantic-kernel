...
public class KernelBotOneOllama : BaseKernelBot
{
    ...
    public KernelBotOneOllama(DiscordEngine engine) : base(engine)
    {
        var builder = Kernel.CreateBuilder();
        builder.Services.AddOllamaChatCompletion(Config.Instance.OllamaModel, new Uri(Config.Instance.OllamaUrl));
